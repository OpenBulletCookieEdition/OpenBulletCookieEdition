...
using OpenBulletCE.Views.Main.Settings;
...
using OpenBulletCE.Views.StackerBlocks;
using RuriLib.LS;
...
namespace OpenBulletCE
{
    ...
    public partial class MainWindow : Window
    {
        ...
        public CookieManager CookieManagerPage { get; set; }
        public CookieManager CookiesManagerPage { get; set; }
        ...
        public MainWindow()
        {
            ...
            var title = $"OpenBullet Cookie Edition {OB.Version}";
            Title = title;
            titleLabel.Content = title;

            // Make sure all folders are there or recreate them
            var folders = new string[] { "Captchas", "ChromeExtensions", "Configs", "DB", "Hits", "Plugins", "Screenshots", "Settings", "Sounds", "Wordlists", "Cookies" };
            ...
            OB.BlockMappings = new List<(Type, Type, System.Windows.Media.Color)>()
            {
                ...
                ( typeof(BlockCookieContainer), typeof(PageBlockCookieContainer),   Colors.PaleVioletRed ),
            ...
            CookieManagerPage = new CookieManager();
            OB.Logger.LogInfo(Components.Main, "Initialized CookieManager");
        ...
        private void menuOptionCookieManager_MouseDown(object sender, MouseButtonEventArgs e)
        {
            Main.Content = CookieManagerPage;
            menuOptionSelected(menuOptionCookieManager);
        }
