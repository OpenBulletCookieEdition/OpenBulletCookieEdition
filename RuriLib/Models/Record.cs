...
namespace RuriLib.Models
{
    ...
    public class Record : Persistable<Guid>
    {
        ...
        public string CookielistLocation { get; set; }
        ...
        public Record(string configName, string wordlistLocation, string cookielistlocation, int checkpoint)
        {
            ConfigName = configName;
            WordlistLocation = wordlistLocation;
            CookielistLocation = cookielistlocation;
